...
| D-22 | 2026-09-06 | Exceção pontual e explícita à D-14 ("saídas têm gatilho"): publicar um guia de uso do sistema (`_projeto/guia-usuario.html`, documentação de método, não conteúdo do vault) via GitHub Pages, e para isso tornar o repositório `esdraaline/BibliaOS` **público**. Decisão do Josemar, confirmada duas vezes depois de eu expor o risco (histórico de commits, PRD e DECISOES.md ficam visíveis a qualquer pessoa, de forma permanente mesmo se voltar a ficar privado depois) e oferecer a alternativa de um repositório novo e separado só para o guia, que ele recusou | Manter o repositório privado e publicar como Artifact; ou criar um repositório novo e separado só para o guia, mantendo o BibliaOS privado | O Josemar quis especificamente o domínio/repositório do BibliaOS no ar via GitHub Pages, ciente da exposição permanente do histórico. Não há conteúdo de estudo no vault hoje (nenhuma nota `consolidado`), o que reduz o risco imediato de expor "tecido" — mas o PRD e o DECISOES.md, que descrevem o método do projeto, ficam públicos | fechada |
| D-21 | 2026-09-06 | Frontmatter dos templates de dossiê padronizado com o DNA do PRD §5.3 (`status: vazio` em `dossie-palavra.md`/`dossie-tema.md` e `status: rascunho` em `porta.md`) e corpo com eixos literais do PRD §8.2 | Criar propriedades extras nos templates ou deixar templates sem frontmatter YAML | Mantém conformidade estrita com o DNA de propriedades do PRD §5.3, sem propriedades novas, e preserva a estrutura de eixos de palavra/tema para instanciar novas notas | fechada |
